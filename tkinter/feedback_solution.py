...
class Feedback:
    def __init__(self, master):
        ...
        self.logo = PhotoImage(file='/home/jkligel/python_programs/tkinter/Exercise_Files/Ch08/tour_logo.gif')
        ttk.Label(self.header_frame, image=self.logo).grid(row=0, column=0, rowspan=2)
        ttk.Label(self.header_frame, text='Thanks for Exploring!', style='Header.TLabel').grid(row=0, column=1)
        ttk.Label(self.header_frame, wraplength=300, text="We're glad you chose Explore California for your recent adventure."
        ...
        self.entry_name = ttk.Entry(self.content_frame, width=24, font=('Arial', 10))
        self.entry_name.grid(row=1, column=0, padx=5)

        self.entry_email = ttk.Entry(self.content_frame, width=24, font=('Arial', 10))
        self.entry_email.grid(row=1, column=1, padx=5)

        self.text_comments = Text(self.content_frame, width=50, height=10, font=('Arial', 10))
